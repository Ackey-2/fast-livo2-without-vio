/**
 * BTC.h - 从 VoxelSLAM 移植，做了以下修改：
 *   1. 删除 #include <execution>（未使用）
 *   2. 给 HASH_P / MAX_N 加 #ifndef 防止与其他头文件冲突
 *   3. 其余完全不动
 */
#pragma once
...
// #include <execution>  // 已删除，VoxelSLAM 中已注释掉并行代码
#include <fstream>
#include <mutex>
...
#ifndef BTC_HASH_P
#define BTC_HASH_P 116101
#endif
#ifndef BTC_MAX_N
#define BTC_MAX_N 10000000000
#endif

// 为了兼容 BTC.cpp 中直接使用 HASH_P / MAX_N 的代码
// 如果你的项目其他地方没定义这两个宏，就直接用
#ifndef HASH_P
#define HASH_P BTC_HASH_P
#endif
#ifndef MAX_N
#define MAX_N BTC_MAX_N
#endif
